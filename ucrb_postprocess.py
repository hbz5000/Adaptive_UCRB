...
fig, ax = plt.subplots()
ax.plot(ucrb.structures_objects['5104634'].historical_monthly_deliveries['deliveries'] - ucrb.structures_objects['5104634'].adaptive_monthly_deliveries['deliveries'], color = 'blue')
plt.show()
